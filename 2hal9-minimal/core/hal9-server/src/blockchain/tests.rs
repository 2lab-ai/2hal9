...
mod tests {
    ...
    mod chain_tests {
        use super::*;
        use crate::blockchain::chain::{ChainConfig, GasConfig, Network};
        ...
        fn test_network_types() {
            ...
            assert_ne!(format!("{:?}", eth), format!("{:?}", polygon));
        }
    ...
    mod consensus_tests {
        use super::*;
        use crate::blockchain::consensus::{ConsensusEngine, ConsensusProtocol};
    ...
    mod contracts_tests {
        ...
        fn test_task_status() {
            ...
            assert_ne!(format!("{:?}", open), format!("{:?}", completed));
        }
    }

    mod incentives_tests {
        use super::*;
        use crate::blockchain::incentives::{EmissionSchedule, FeeStructure, TokenEconomics};
    ...
    mod proof_tests {
        use super::*;
        use crate::blockchain::proof::{ProofBuilder, ProofType, ProofVerifier};
        ...
        async fn test_proof_building() {
            ...
            builder.add_step("process".to_string(), b"input", b"output", 100);

            let proof =
                builder.build_deterministic(42, H256::random(), b"test input", b"test output");
        ...
        async fn test_proof_verification() {
            ...
            let proof = builder.build_deterministic(1, H256::random(), b"input", b"output");
    ...
    mod storage_tests {
        ...
        use crate::blockchain::storage::{
            IPFSConfig, ProofType as StorageProofType, StorageProvider,
        };
        ...
        fn test_storage_providers() {
            ...
            assert_ne!(format!("{:?}", ipfs), format!("{:?}", arweave));
        }
