...
impl Protocol for SignalProtocol {
    ...
    async fn negotiate(&self, peer_capabilities: &ProtocolCapabilities) -> Result<NegotiatedProtocol> {
        ...
        let compression = if peer_capabilities.compression.contains(&CompressionType::Lz4) {
            CompressionType::Lz4
    ...
    fn capabilities(&self) -> ProtocolCapabilities {
        ProtocolCapabilities {
            compression: vec![CompressionType::None, CompressionType::Gzip, CompressionType::Lz4],
