...
RUST_LOG=debug,hyper=info,tower=info HTTP_PORT=8081 ./target/release/hal9-server \
    ./examples/config-server1.yaml \
...
RUST_LOG=debug,hyper=info,tower=info HTTP_PORT=8082 ./target/release/hal9-server \
    ./examples/config-server2.yaml \
