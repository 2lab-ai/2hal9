...
use twohal9_core::{NeuronSignal, NeuronConfig, ServerConfig, config::{ClaudeConfig, MockResponse}};
use twohal9_server::{HAL9Server, MockClaude, ManagedNeuron};

/// Create a test configuration optimized for performance
fn create_performance_config() -> ServerConfig {
    use std::collections::HashMap;
    use twohal9_core::config::{MonitoringConfig, CostControls};
